...
EXT_COL_2 VARCHAR(100),
EXT_COL_3 VARCHAR(100),
CONSTRAINT fk_uid_patient_med_record FOREIGN KEY (UID) REFERENCES PATIENT_PRIMARY(UID) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
OTP INT(10) primary key auto_increment,
REMARKS CHAR(1)
);
